...
const validatePassword = require('../middleware/password.validation');
...
module.exports = {
  ...
  async createUser(req, res) {
    ...
    file.mv(`./public/users/${nameImage}`, async () => {
      const validationEmail = await Users.findOne({ where: { email } });
